...
export default function A5page() {
  const reason1Toast = () => {
    ...
    title: "#1",
    description:
    "He was dropped into a vat of acid and became crazy",
    color: "blue",
    });}
    const reason2Toast = () => {
      addToast({
  ...
  return (
    <>
      ...
      <ul><b>Three reasons why joker wasn't completely evil:</b></ul>
      <Button
        onPress={() => reason1Toast()}>Reason #1</Button>
        <Button
        onPress={() => reason2Toast()}>Reason #2</Button>
        <Button
        onPress={() => reason3Toast()}>Reason #3</Button>
